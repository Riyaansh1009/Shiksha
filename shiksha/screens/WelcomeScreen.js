        ...
        <View style = {styles.container} >
          ...
          {this.showModal()}
            ...
            <View>
                ...
                <Text style = {styles.title}> Shiksha </Text>
            </View>
            <View>
      ...
      <View style = {styles.modalContainer}>
        <ScrollView> 
          <KeyboardAvoidingView>
            ...
            <TextInput style = {styles.formTextInput} placeholder = {"Last Name"} maxLength ={13} onChangeText = {(text)=>{this.setState({Last_Name: text})}}/>
